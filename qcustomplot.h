...
/********************************
 *
 *  This library of classes is the base of all types of figures that can be
 *  drawn in this app
 *
 *  Its documentation can be found at:
 *  https://www.qcustomplot.com/
 *
 *  For a full list of classes and functions please consult the documentation.
 *
 *  A good apparoch to set a new graph or test a feature is to copy an example
 *  code from the documentation and paste it in this code, then make the necessary
 *  adjustments.
 *
 *  Many of the functions defined in this library were overloaded to work with
 *  datatypes defined in GSL library, if you are using any more functions from
 *  this library please overload them to work with GSL datatypes.
 *
**********************************/
...
signals:
  ...
  void mouseContextMenuEvent(QContextMenuEvent *event);
...
private:
    ...
    // # New feature 2: set names of axises
